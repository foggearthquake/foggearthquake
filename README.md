...
**AI / LLM Engineer · автоматизация бизнеса.** Строю и довожу до прода RAG-системы, мульти-агентов, чат-ботов и голосовых агентов. Бэкграунд — инженер-технолог и project manager в digital и нефтегазе.

🟢 **Open to work** — AI Engineer / AI-разработчик / автоматизация. Москва, удалёнка/гибрид/офис.

- 🔭 Свой SaaS-продукт — победитель гранта Фонда содействия инновациям (1 млн ₽)
- 🛠️ 10–15 платных AI-кейсов: маркетинг, продажи, e-commerce, услуги, B2B, промышленность
- 🌐 Сайт и кейсы: **[gabdra.pw](https://gabdra.pw)**
- ✉️ foggearthquake@gmail.com · Telegram по запросу
...
`Python` · `FastAPI` · `OpenAI` · `Claude` · `Gemini` · `LangChain / LangGraph` · `pgvector` · `Qdrant` · `Celery` · `Redis` · `PostgreSQL` · `Docker` · `Next.js` · `n8n` · `Bitrix24`

---

📍 Москва · 🎓 РГУ нефти и газа им. Губкина (магистр), УГНТУ (инженер, химическая кибернетика — Python и ML)
